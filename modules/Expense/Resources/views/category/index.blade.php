            ...
            <div class="card" style="border-radius: 10px;">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a href="{{ route('backend.expense-categories.create') }}" class="btn btn-success">Create</a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                                    ...
                                    <tbody>
                                        @foreach($expenseCategories as $expenseCategory)
                                            <tr>
                                                ...
                                                <td class="text-center">{{ $expenseCategory->status }}</td>
                                                <td class="text-end">
                                                    <div class="d-flex justify-content-end align-items-center">
                                                        <a href="{{ route('backend.expense-categories.edit', $expenseCategory->id)}}" class="btn btn-sm">
                                                            <i class="ph-note-pencil-bold text-success fs-3"></i>
                                                        </a>
                                                        <form action="{{ route('backend.expense-categories.destroy', $expenseCategory->id)}}" method="POST" onsubmit="return confirm('Are you sure?');">
                                                            @csrf
                                                            @method('delete')
